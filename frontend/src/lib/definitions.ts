...
export const TERMS: Term[] = [
  ...
  // ─────────────────────────── ESTILOS DE JOGO ───────────────────────────
  {
    ...
    example: "A Argentina pode receber o rótulo 'Compacto/Reativo' e a Espanha 'Posse/Construção' — duas tendências diferentes, sem dizer qual é melhor.",
    related: ["estilo_posse", "estilo_pressao_alta", "estilo_contra_ataque", "estilo_retranca", "estilo_jogo_direto", "estilo_bola_parada"],
  },
  {
    id: "estilo_posse", term: "Estilo: Posse/Construção", category: "estilos",
    short: "Constrói com bola, progride e tenta ocupar o terço final.",
    full: "Time com tendência dominante em construção (livre e sob pressão), progressão e presença no terço final. É controle com bola, não apenas posse por posse.",
  ...
  {
    id: "estilo_pressao_alta", term: "Estilo: Pressão/Recuperação", category: "estilos",
    short: "Tem sinal forte de pressão, bloco alto, contrapressão ou recuperação.",
    full: "Time com tendência dominante em pressão alta, bloco alto, contrapressão e recuperação. Não significa pressionar alto o jogo inteiro; pode aparecer por recuperar bem a bola ou defender mais adiantado que a média.",
    formula: "pressão alta + bloco alto + contra-pressão + recuperação",
    example: "Uma seleção pode cair aqui por pressionar a saída ou por recuperar muitas bolas em zonas altas/intermediárias.",
    related: ["estilo_jogo", "pressao_defensiva"],
  },
  {
    id: "estilo_contra_ataque", term: "Estilo: Transição Rápida", category: "estilos",
    short: "Acelera quando recupera a bola.",
    full: "Time com tendência dominante em contra-ataque e transição ofensiva. Não é necessariamente passivo: o ponto é atacar rápido quando encontra espaço.",
  ...
  {
    id: "estilo_retranca", term: "Estilo: Compacto/Reativo", category: "estilos",
    short: "Defende mais compacto e administra risco.",
    full: "Time com tendência dominante em bloco baixo, pressão baixa e transição defensiva. O rótulo indica compactação e gestão de risco; não é juízo de qualidade nem quer dizer que o time só se defende.",
    formula: "bloco baixo + pressão baixa + transição defensiva",
    example: "Uma seleção com bom resultado e poucos espaços cedidos pode aparecer aqui mesmo sem jogar de forma passiva o tempo todo.",
    related: ["estilo_jogo", "estilo_contra_ataque", "score_defesa"],
  },
  {
    id: "estilo_jogo_direto", term: "Estilo: Jogo Direto", category: "estilos",
    short: "Ganha campo com bola longa e ataque vertical.",
    full: "Time com tendência dominante em bola longa e ataque vertical para ganhar campo rápido. Pode ser escolha estratégica, não necessariamente falta de construção.",
    formula: "bola longa",
  ...
  },
  {
    ...
    short: "Gera peso relevante em escanteios, faltas e outras bolas paradas.",
    full: "Time com tendência dominante de criação ou perigo em situações de bola parada — escanteios, faltas e pênaltis.",
